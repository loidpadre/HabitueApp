...
export const Card = ({ casa }) => {
    ...
    return (
        ...
        <div className="w-full sm:w-3/4 md:w-64 rounded-xl flex flex-col hover:cursor-pointer hover:shadow-lg hover:scale-105 transition duration-200 ease-in-out gap-5 bg-orange-700 text-white">
            <img src={image.imagePrincipal} className="w-full h-60 object-cover rounded-t-xl" alt="Imagem da Casa" />
            <div className="p-5">
                ...
                <div className="flex flex-col justify-center items-end mb-0">
                    <button className="mt-4 p-2 rounded-md w-full bg-zinc-900 text-white">
                        <Link to={`detail/${id}`}>Ver detalhes</Link>
                    </button>
                    <div className="mt-2 justify-center p-2 flex gap-5 rounded-md w-full bg-green-700 text-white">
