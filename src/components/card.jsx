...
export const Card = ({casa} ) =>{
    ...
    return(
        <div className="w-64 rounded-xl flex flex-col hover:cursor-pointer hover:shadow-lg hover:scale-105 transition duration-200 ease-in-out  gap-5 bg-orange-700 text-white">
            ...
            <div className="p-5">
                ...
                <div className="flex flex-col justify-center items-end align-bottom mb-0">
